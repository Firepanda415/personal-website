...
function diagram(kind, compact = false) {
  ...
  switch (kind) {
    case 'library':
      ...
      break;
    case 'hybrid':
      drawing = lines('M52 60 H285 M52 125 H285') + text(16,64,'CV') + text(16,129,'DV') + '<rect x="116" y="33" width="98" height="54" fill="var(--paper)" stroke="var(--accent)" stroke-width="1.5"/>' + lines('M126 60 C133 35 140 35 147 60 S161 85 168 60 S182 35 189 60 S199 80 204 60','var(--accent)') + lines('M165 87 V109','var(--accent)') + '<rect x="149" y="109" width="32" height="32" fill="var(--paper)" stroke="var(--accent)" stroke-width="1.5"/>' + text(160,130,'U') + text(68,173,'CV-CONTROLLED DV');
      break;
    case 'downfolding':
