...
function diagram(kind, compact = false) {
  ...
  switch (kind) {
    case 'library':
      ...
      break;
    case 'hybrid':
      drawing = lines('M52 60 H285 M52 125 H285') + text(16,64,'CV') + text(16,129,'DV') + '<rect x="72" y="33" width="98" height="54" fill="var(--paper)" stroke="var(--accent)" stroke-width="1.5"/>' + lines('M82 60 C89 35 96 35 103 60 S117 85 124 60 S138 35 145 60 S155 80 160 60','var(--accent)') + lines('M236 60 V125','var(--accent)') + '<circle cx="236" cy="60" r="4" fill="var(--accent)"/><rect x="220" y="109" width="32" height="32" fill="var(--paper)" stroke="var(--accent)" stroke-width="1.5"/>' + text(231,130,'U') + text(68,173,'CV-CONTROLLED DV');
      break;
    case 'downfolding':
